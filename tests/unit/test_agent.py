...
class TestAgent(unittest.TestCase):
    ...
    def test_get_account_balance(self):
        ...
        expected_result = {"rt_cd": "0", "msg1": "성공", "output": [{"balance": "1000000"}]}
    ...
    def test_get_program_trade_by_stock(self):
        ...
        expected_result = {"rt_cd": "0", "msg1": "성공", "output": [{"program_data": "test"}]}
        ...
        self.assertEqual(result, expected_result)
        self.agent.program_api.get_program_trade_by_stock.assert_called_once_with(self.test_stock_code)

    def test_get_stock_price(self):
        """주식 현재가 조회 테스트 - Mock 사용"""
        expected_result = {"rt_cd": "0", "msg1": "성공", "output": {"stck_prpr": "70000"}}
        ...
        self.assertEqual(result, expected_result)
        self.agent.stock_api.get_stock_price.assert_called_once_with(self.test_stock_code)

    def test_get_daily_price(self):
        """주식 일별 시세 조회 테스트 - Mock 사용"""
        expected_result = {"rt_cd": "0", "msg1": "성공", "output": [{"stck_bsop_date": "20231215", "stck_clpr": "70000"}]}
        self.agent.stock_api = Mock()
        ...
        self.assertEqual(result, expected_result)
        self.agent.stock_api.get_daily_price.assert_called_once_with(self.test_stock_code, 'D', '1')

    def test_get_orderbook(self):
        """호가 정보 조회 테스트 - Mock 사용"""
        expected_result = {"rt_cd": "0", "msg1": "성공", "output": {"askp1": "70100", "bidp1": "70000"}}
        self.agent.stock_api = Mock()
    ...
    def test_get_stock_investor(self):
        ...
        expected_result = {"rt_cd": "0", "msg1": "성공", "output": {"investor_data": "test"}}
        self.agent.stock_api = Mock()
        ...
        self.assertEqual(result, expected_result)
        self.agent.stock_api.get_stock_investor.assert_called_once_with(self.test_stock_code)

    def test_get_volume_power(self):
        """체결강도 순위 조회 테스트 - Mock 사용"""
        expected_result = {"rt_cd": "0", "msg1": "성공", "output": [{"code": "005930", "power": "150.5"}]}
        self.agent.stock_api = Mock()
    ...
    def test_get_top_gainers(self):
        ...
        expected_result = {"rt_cd": "0", "msg1": "성공", "output": [{"rank": 1, "code": "005930"}]}
    ...
    def test_get_member(self):
        ...
        expected_result = {"rt_cd": "0", "msg1": "성공", "output": {"member_data": "test"}}
    ...
    def test_get_member_transaction(self):
        ...
        expected_result = {"rt_cd": "0", "msg1": "성공", "output": {"transaction_data": "test"}}
        self.agent.stock_api = Mock()
        ...
        self.assertEqual(result, expected_result)
        self.agent.stock_api.get_member_transaction.assert_called_once_with(self.test_stock_code, '99999')
    ...
    def test_fetch_minute_data(self):
        ...
        self.agent.fetch_minute_data.assert_called_once_with(self.test_stock_code, test_date)
    ...
    def test_search_methods(self):
        ...
        expected_result = [{'name': 'get_stock_price', 'description': 'Get stock price', 'category': 'stock'}]
