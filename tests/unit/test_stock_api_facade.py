...
class TestStockAPIFacade(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch('pykis.stock.api_facade.StockPriceAPI'), \
             patch('pykis.stock.api_facade.StockMarketAPI'), \
    ...
    def test_get_daily_minute_price_delegation(self):
        ...
        self.assertEqual(result, expected_result)
        self.api.price_api.get_daily_minute_price.assert_called_once_with("005930", "20231215", "090000")
    ...
    def test_get_daily_minute_price_default_hour(self):
        ...
        self.assertEqual(result, expected_result)
        self.api.price_api.get_daily_minute_price.assert_called_once_with("005930", "20231215", "153000")
    ...
    def test_get_stock_investor_delegation(self):
        ...
        result = self.api.get_stock_investor(ticker="005930", retries=5, force_refresh=True)
        
        self.assertEqual(result, expected_result)
        self.api.investor_api.get_stock_investor.assert_called_once_with("005930", 5, True)
    ...
    def test_get_member_transaction_delegation(self):
        ...
        self.api.investor_api.get_member_transaction = Mock(return_value=expected_result)
        
        result = self.api.get_member_transaction("005930", "001")
        
        self.assertEqual(result, expected_result)
        self.api.investor_api.get_member_transaction.assert_called_once_with("005930", "001")
    ...
    def test_get_frgnmem_pchs_trend_delegation(self):
        ...
        self.api.investor_api.get_frgnmem_pchs_trend = Mock(return_value=expected_result)
        
        result = self.api.get_frgnmem_pchs_trend("005930", "20231215")
        
        self.assertEqual(result, expected_result)
        self.api.investor_api.get_frgnmem_pchs_trend.assert_called_once_with("005930", "20231215")
    ...
    def test_get_foreign_broker_net_buy_delegation(self):
        ...
        self.api.investor_api.get_foreign_broker_net_buy = Mock(return_value=expected_result)
        
        foreign_brokers = ["morgan", "goldman"]
        result = self.api.get_foreign_broker_net_buy("005930", foreign_brokers, "20231215")
        
        self.assertEqual(result, expected_result)
        self.api.investor_api.get_foreign_broker_net_buy.assert_called_once_with("005930", foreign_brokers, "20231215")
    ...
    def test_get_foreign_broker_net_buy_default_params(self):
        ...
        self.assertEqual(result, expected_result)
        self.api.investor_api.get_foreign_broker_net_buy.assert_called_once_with("005930", None, None)
