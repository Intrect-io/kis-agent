...
class TestGenerateTradingReport:
    ...
    def test_generate_trading_report_function(self, mock_client, account_info, sample_trading_data):
        """간편 함수 테스트"""
    ...
    def test_generate_trading_report_with_options(self, mock_client, account_info, sample_trading_data):
        """다양한 옵션으로 간편 함수 테스트"""
        with patch('pykis.utils.trading_report.AccountAPI') as MockAccountAPI:
            mock_api = MockAccountAPI.return_value
            mock_api.inquire_daily_ccld.return_value = sample_trading_data
